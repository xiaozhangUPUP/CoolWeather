...
import com.android.coolweather.bean.Forecast;
import com.android.coolweather.bean.Weather;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    private TextView titleCity, titleUpdateTime, degreeText, sportText, weatherInfoText, aqiText, pm25Text, comfortText, carWashText;
    ...
    public void requestWeather(final String weatherId) {
        String weatherUrl = "http://guolin.tech/api/weather?cityid="
                + weatherId + "&key=7165915dab21406d894d0784b2410a3c";
